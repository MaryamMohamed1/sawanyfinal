...
class _TrainerStudentsScreenState extends State<TrainerStudentsScreen> {
  ...
  // بيانات وهمية للمتدربين مع صور حقيقية
  final List<Map<String, dynamic>> students = [
    {
      'name': 'عمر محمد',
      'progress': 60,
      'image': 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=200&auto=format&fit=crop', // صورة شاب محترفة
      'level': 'رخصة القيادة الخاصة - المرحلة المتوسطة',
    },
    {
      'name': 'لينا أحمد',
      'progress': 30,
      'image': 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=200&auto=format&fit=crop', // صورة شابة محترفة
      'level': 'رخصة القيادة الخاصة - مرحلة المبتدئين',
    },
    {
      'name': 'سامي حسن',
      'progress': 15,
      'image': 'https://images.unsplash.com/photo-1520155707862-5b32817388d6?q=80&w=200&auto=format&fit=crop', // صورة شاب أخرى محترفة
