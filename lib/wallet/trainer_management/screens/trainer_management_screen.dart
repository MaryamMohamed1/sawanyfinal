...
class _TrainerManagementScreenState extends State<TrainerManagementScreen> {
  ...
  final List<TrainerModel> trainers = [
    TrainerModel(
      name: 'أحمد محمود',
      // صورة رمزية واقعية ومحترفة لرجل عربي موثوق
      image: 'https://img.api.photo/avatar/real-arab-male-trainer-pfp-square.jpg', 
    ...
    TrainerModel(
      name: 'سارة حسن',
      // صورة رمزية واقعية ومحترفة لامرأة عربية ودودة
      image: 'https://img.api.photo/avatar/real-arab-female-trainer-pfp-square.jpg', 
    ...
    TrainerModel(
      name: 'ياسر فوزي',
      // صورة رمزية واقعية ومحترفة لرجل عربي شاب ماهر
      image: 'https://img.api.photo/avatar/real-arab-male-trainer-pfp-2-square.jpg', 
      verificationStatus: 'موثق',
      reliabilityScore: 90,
      rating: 5.0,
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Material(
        ...
        child: Column(
          children: [
            SchoolAppBar(title: 'إدارة المدربين', onNotificationPressed: () {}),
            Expanded(child: _buildTrainerManagementContent()),
          ],
        ),
      ),
    );
