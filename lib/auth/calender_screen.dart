      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: const Icon(
              Icons.arrow_back_ios_new_rounded, // تعديل الأيقونة لتكون بشكل أنعم ومتناسق مع الـ RTL
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    // --- تعديل مربع الصورة لأفتار مدرب حقيقي 📸 ---
                    ClipRRect(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: active
                                ...
                                : const Color(0xFF000000),
                            fontWeight: FontWeight.bold,
                            fontSize: 13, // تعديل بسيط لضمان التفاف النص بشكل سليم
                          ),
                        ),
                      ),
                    ),
