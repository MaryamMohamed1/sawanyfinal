...
class SessionStatsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // إضافة Directionality هنا تجبر الكارت يعرض المحتوى من اليمين للشمال (عربي)
          ...
          children: [
            ...
            Row(
              children: [
                const CircleAvatar(
                  radius: 25,
backgroundImage: const NetworkImage('https://images.unsplash.com/photo-1590086782957-93c06ef21604?auto=format&fit=crop&q=80&w=200'),                ),
  ...
  // الميثود المسؤولة عن بناء الصفوف الفرعية
  Widget _buildDetailRow({required IconData icon, required String title, required String subtitle}) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start, // الكود ده مع الـ Directionality هيخلي الكلام يبدأ من اليمين
            children: [
              Text(
                title,
