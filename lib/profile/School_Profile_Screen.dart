      ...
      leading: Padding(
        ...
        child: CircleAvatar(
          ...
          child: IconButton(
            ...
            // تعديل زرار الرجوع عشان يرجعك للشاشة اللي قبلها صح
      ...
      flexibleSpace: FlexibleSpaceBar(
        background: Stack(
          ...
          children: [
            // Cover Image
            Image.network(
'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=200&auto=format&fit=crop',              fit: BoxFit.cover,
            ),
            // Gradient Overlay
            Container(
